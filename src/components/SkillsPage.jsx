    ...
    <>
      ...
      <Box
        ...
        sx={{
          ...
          alignItems: "center",
          visibility: skillsVisible ? "unset" : "hidden",
        }}
      >
        <Typography
          sx={{
        ...
        >
          <Zoom left>Skills & Technologies</Zoom>{" "}
        </Typography>

        <br />
        <Box
          ref={SkillsImgRef}
          sx={{ visibility: skillsImgVisible ? "unset" : "hidden" }}
        >
          <LightSpeed>
            <Grid sx={{ width: "100%" }} container spacing={3}>
              ...
              >
                ...
                <Box
                  sx={{
                    "&:hover": { filter: "drop-shadow(0 0 0.5rem black)" },
                  }}
                >
                  <motion.img
