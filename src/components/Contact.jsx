...
export default function Contact(props) {
  ...
  return (
    ...
    <Box  sx={{display:"flex", justifyContent:"center", flexDirection:"column",  width:"90%", mb:"5%" }}>      
            ...
            <Zoom left > 
            <Typography ref={props.refProp3} sx={{mb:"8%", fontFamily:"Cormorant, serif", fontWeight:"600", textAlign:"center"}}  variant={isSmallScreen ? 'h2' : 'h1'}>
                Get In Touch </Typography> </Zoom>
                </Box>
            <Zoom> <Typography sx={{mb:"1%"}} variant='h5'> Name </Typography> </Zoom>
            <TextField color='secondary' label="Name" placeholder='Name' required/>
        <br/>
            <Zoom><Typography sx={{mb:"1%"}} variant='h5'> Email Address </Typography> </Zoom>
            <TextField color='secondary' label="Email" placeholder='Email Address' required/> 
        <br/>
            <Zoom><Typography sx={{mb:"1%"}} variant='h5'> Message </Typography> </Zoom>
