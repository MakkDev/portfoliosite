...
const buttonProps = {
    ...
    return (
        ...
        <Container ref={ProjectsRef} sx={{display: "flex", justifyContent: "center", mt: "5%", flexDirection: "column", alignItems: "center", visibility: projectsVisible ? "unset" : "hidden" }}>           
            ...
            <Box sx={{display:"flex",  alignItems:"center", mb:"10%", ml:"5%" }}> 
            <Grid sx={{ display: "flex", justifyContent: "center", alignItems: "center", }} container spacing={isSmallScreen ? 9 : 14}>
                <Grid sx={{ display: "flex", flexDirection: "column", alignItems: "center", }} item xs={6}>
                        ...
                        <Rotate bottom right> 
                    <Card sx={{width:{xs:"85%", sm:"95%", md:"100%"}, display:"flex", flexDirection:"column",  mt:"3%", backgroundColor:"#dae0e0",  "&:hover": { boxShadow:"0 4px 15px 0 rgba(45, 54, 65, 0.75)"}}}>
                        ...
                        <CardContent sx={{display:"flex", justifyContent:"center", flexDirection:"column", mt:"1%", backgroundColor: "#dae0e0"}}>
                            <Stack sx={{justifyContent:"center", alignItems:"center", mb:"3%", }}>
                                <Typography variant={isSmallScreen ? 'h5':'h4'}>Skills Displayed:</Typography>
                                <Box sx={{justifyContent:"flex-start",  width:"90%"}}>
                                    <Grid container spacing={6}>
                                        <Grid item xs={6}> 
                                    <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>React JS</Typography>
                                    <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>Material UI</Typography>
                                    <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>User Authentication</Typography>    
                                        </Grid> 
                                        <Grid item xs={6}>
                ...
                <Rotate bottom left>  
                    <Card sx={{width:{xs:"90%", sm:"95%", md:"100%"}, display:"flex", flexDirection:"column", mt:"3%", backgroundColor:"#dae0e0",  "&:hover": { boxShadow:"0 4px 15px 0 rgba(45, 54, 65, 0.75)"} }}>
                        ...
                        <CardContent sx={{display:"flex", justifyContent:"center", flexDirection:"column", mt:"1%", backgroundColor: "#dae0e0"}}>
                            <Stack sx={{justifyContent:"center", alignItems:"center", mb:"3%", }}>
                                ...
                                <Box sx={{display:"flex", justifyContent:"center", alignItems:"center", width:"90%"}}>
                                    ...
                                    <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>User Authentication</Typography>    
                                        ...
                                        <Grid item xs={6}>
                                            <List sx={{listStyleType:'disc'}}> 
                                 <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>React Hooks</Typography> 
                                  <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>Pagination</Typography> 
                                 <Typography sx={{ display: 'list-item' }} variant={isSmallScreen ? 'h7': "h6"}>CoinGecko API Integration</Typography>             
                                        </List>     
                                        </Grid> 
                                    </Grid> 
                                </Box>
                            ...
                            <Box sx={{display:"flex", justifyContent:"space-around",}}> 
                            <Button {...buttonProps} sx={{fontFamily:"Montserrat" , fontWeight:"600", ml:"2%", color:"#dae0e0", backgroundColor:"#020004", borderColor:"#dae0e0", "&:hover": {color:"#06000C", backgroundImage: "linear-gradient(to right, #D9BFE6, #B380CC, #8C40B3  )"}}} variant='contained' > Live Demo </Button>
                            <Button size='medium' sx={{fontFamily:"Montserrat" ,fontWeight:"600", mr:"2%",color:"#06000C", backgroundColor:"#dae0e0", borderColor:"#020004", "&:hover": { backgroundImage: "linear-gradient(to right, #D9BFE6, #B380CC, #8C40B3  )"}}} variant='contained'>View Code</Button>
                            </Box> 
                       </CardContent>
                    </Card>
                    </Rotate>
